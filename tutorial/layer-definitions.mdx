...
To create a layer you must first create the Terraform files that belong to it. Then, you must create a JSON file called `layerform.json` to be able to provision a layer definition.
