...
<div className="flex justify-center items-center">
    <img src="../images/octopus-spawn.png" className="w-96" />
</div>
...
In most companies, you'd have a single "staging" environment with a large Kubernetes cluster, quite a few instances of Elasticsearch and Kibana.
